...
-- Using tagged dollar-quoted string ($bcrypt$...$bcrypt$) to include $ in BCrypt hash
INSERT INTO accounts_schema.users (username, password, first_name, last_name, email, birth_date) VALUES
('john', $bcrypt$$2a$10$mbDSFQBj5HbrA0XyS0WhXe6GQt86B2JHip4eLUMJvmIpbUqZx5Nuy$bcrypt$, 'John', 'Doe', 'john.doe@example.com', '1985-05-15'),
('jane', $bcrypt$$2a$10$mbDSFQBj5HbrA0XyS0WhXe6GQt86B2JHip4eLUMJvmIpbUqZx5Nuy$bcrypt$, 'Jane', 'Smith', 'jane.smith@example.com', '1990-08-22'),
('bob', $bcrypt$$2a$10$mbDSFQBj5HbrA0XyS0WhXe6GQt86B2JHip4eLUMJvmIpbUqZx5Nuy$bcrypt$, 'Bob', 'Wilson', 'bob.wilson@example.com', '1988-12-03')
